...
# Title: VCC TX/RX, w/ Doppler Tuning
# Author: Zach Leffke, KJ4QLP
# Description: Development transmitter or testing Lithium Radio
#
# Generated: Thu Jul  4 15:10:49 2019
...
class fsk_trx_uhd_v2(gr.top_block, Qt.QWidget):

    def __init__(self, radio_id='30CF9D2', rf_freq=401.12e6, rx_offset=250e3/4, sat_name='CERES', tx_offset=250e3):
        gr.top_block.__init__(self, "VCC TX/RX, w/ Doppler Tuning")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("VCC TX/RX, w/ Doppler Tuning")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fsk_trx_uhd_v2")
        ...
        self.connect((self.blocks_file_source_0, 0), (self.fsk_rx_hier_0, 0))
...
def main(top_block_cls=fsk_trx_uhd_v2, options=None):
    if options is None:
