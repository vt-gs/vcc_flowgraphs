...
# Title: VCC Burst TX/RX, 9600 Baud GFSK, AX.25, w/ PTT
# Author: Zach Leffke, KJ4QLP
# Description: VCC Burst TX/RX, 9600 Baud GFSK, AX.25
...
from gfsk_tx_burst_hier import gfsk_tx_burst_hier  # grc-generated hier_block
...
class burst_trx_gfsk9600_ax25_n210(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "VCC Burst TX/RX, 9600 Baud GFSK, AX.25, w/ PTT")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("VCC Burst TX/RX, 9600 Baud GFSK, AX.25, w/ PTT")
        ...
        self.msg_connect((self.blocks_socket_pdu_0_2, 'pdus'), (self.gfsk_tx_burst_hier_0, 'kiss/ax25'))
        ...
        self.msg_connect((self.gfsk_tx_burst_hier_0, 'ax25'), (self.vcc_qt_hex_text_tx, 'pdus'))
        ...
        self.connect((self.gfsk_tx_burst_hier_0, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.gfsk_tx_burst_hier_0, 0), (self.rffe_ctl_tag_ptt_pdu_0, 0))
    ...
    def set_bb_gain(self, bb_gain):
        ...
        self.gfsk_tx_burst_hier_0.set_bb_gain(self.bb_gain)


def main(top_block_cls=burst_trx_gfsk9600_ax25_n210, options=None):
