...
# Title: VCC Simple Transceiver, CERES_30CF9D2_20190506_030705.059214_UTC_250k.fc32
...
class fsk_trx_file(gr.top_block, Qt.QWidget):

    def __init__(self, radio_id='30CF9D2', rf_freq=401.12e6, rx_offset=250e3/4, sat_name='CERES', tx_offset=250e3):
        gr.top_block.__init__(self, "VCC Simple Transceiver, CERES_30CF9D2_20190506_030705.059214_UTC_250k.fc32")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("VCC Simple Transceiver, CERES_30CF9D2_20190506_030705.059214_UTC_250k.fc32")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fsk_trx_file")
        ...
        self.connect((self.blocks_throttle_0, 0), (self.fsk_rx_hier_0, 0))
...
def main(top_block_cls=fsk_trx_file, options=None):
    if options is None:
