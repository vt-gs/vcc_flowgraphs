...
class rx_ota_1200(gr.top_block, Qt.QWidget):

    def __init__(self, lpf_cutoff=7.2e3, lpf_trans=1e3, quad_demod_gain=6.1):
        gr.top_block.__init__(self, "Rx Ota 1200")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rx Ota 1200")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rx_ota_1200")
        ...
        self.samps_per_symb = samps_per_symb = 5*8
        self.samp_rate = samp_rate = 500000
        self.rx_offset = rx_offset = 4.35e3
        self.rx_gain = rx_gain = 20
        self.rx_freq = rx_freq = 416.513e6
        ...
        self._samps_per_symb_range = Range(30, 50, 0.001, 5*8, 200)
        ...
        self.main_tab_grid_layout_0.addWidget(self._rx_gain_tool_bar, 8, 2, 1, 2)
        for r in range(8, 9):
        ...
        self.main_tab_grid_layout_0.addWidget(self._rx_freq_tool_bar, 8, 0, 1, 2)
        for r in range(8, 9):
            self.main_tab_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 2):
            self.main_tab_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.uhd_usrp_source_1.set_center_freq(uhd.tune_request(rx_freq-rx_offset, samp_rate/2), 0)
        ...
        self.qtgui_time_sink_x_0_0_0_0 = qtgui.time_sink_f(
        	4096, #size
        	samp_rate /2/decim * interp / samps_per_symb, #samp_rate
        	"Descrambled", #name
        	1 #number of inputs
        )
    ...
    def set_interp(self, interp):
        ...
        self.qtgui_time_sink_x_0_0_0_0.set_samp_rate(self.samp_rate /2/self.decim * self.interp / self.samps_per_symb)
        self.qtgui_time_sink_x_0_0_0.set_samp_rate(self.samp_rate /2/self.decim * self.interp / self.samps_per_symb)
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.samp_rate /2/self.decim * self.interp / self.samps_per_symb)
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate / 2 / self.decim * self.interp / self.samps_per_symb)
        self.qtgui_freq_sink_x_1_0.set_frequency_range(0, self.samp_rate / self.decim*self.interp / self.decim_2 * self.interp_2)
        self.qtgui_freq_sink_x_1.set_frequency_range(0, self.samp_rate*self.interp/self.decim*self.interp_2/self.decim_2)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.uhd_usrp_source_1.set_center_freq(uhd.tune_request(self.rx_freq-self.rx_offset, self.samp_rate/2), 0)
        self.qtgui_waterfall_sink_x_1.set_frequency_range(0, self.samp_rate/self.decim*self.interp)
        self.qtgui_waterfall_sink_x_0_0.set_frequency_range(0, self.samp_rate / self.decim*self.interp / self.decim_2 * self.interp_2)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(0, self.samp_rate/self.decim*self.interp)
        self.qtgui_time_sink_x_0_0_0_0.set_samp_rate(self.samp_rate /2/self.decim * self.interp / self.samps_per_symb)
...
def main(top_block_cls=rx_ota_1200, options=None):
    if options is None:
