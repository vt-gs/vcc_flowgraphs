...
class playback_ota(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Playback Ota")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Playback Ota")
        ...
        self.settings = Qt.QSettings("GNU Radio", "playback_ota")
        ...
        self.uhd_usrp_sink_0.set_samp_rate(2.5e6)
...
def main(top_block_cls=playback_ota, options=None):
