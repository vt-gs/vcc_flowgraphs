...
class rx_ota(gr.top_block, Qt.QWidget):

    def __init__(self, lpf_cutoff=7.2e3, lpf_trans=1e3, quad_demod_gain=6.1):
        gr.top_block.__init__(self, "Rx Ota")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rx Ota")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rx_ota")
...
def main(top_block_cls=rx_ota, options=None):
    if options is None:
