...
# Title: VCC Single Channel Command - ODU
...
class burst_trx_gmsk9600_ax25_n210_odu(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "VCC Single Channel Command - ODU")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("VCC Single Channel Command - ODU")
        ...
        self.settings = Qt.QSettings("GNU Radio", "burst_trx_gmsk9600_ax25_n210_odu")
        ...
        self.aeternitas_offset = aeternitas_offset = 0
        ...
        for c in range(2, 3):
            self.main_tab_grid_layout_2.setColumnStretch(c, 1)
        self._aeternitas_offset_tool_bar = Qt.QToolBar(self)
        self._aeternitas_offset_tool_bar.addWidget(Qt.QLabel('Offset'+": "))
        self._aeternitas_offset_line_edit = Qt.QLineEdit(str(self.aeternitas_offset))
        self._aeternitas_offset_tool_bar.addWidget(self._aeternitas_offset_line_edit)
        self._aeternitas_offset_line_edit.returnPressed.connect(
        	lambda: self.set_aeternitas_offset(eng_notation.str_to_num(str(self._aeternitas_offset_line_edit.text().toAscii()))))
        self.main_tab_grid_layout_1.addWidget(self._aeternitas_offset_tool_bar, 3, 4, 1, 2)
        for r in range(3, 4):
            self.main_tab_grid_layout_1.setRowStretch(r, 1)
        for c in range(4, 6):
            self.main_tab_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, -1 * aeternitas_offset, 1, 0)
    ...
    def get_aeternitas_offset(self):
        return self.aeternitas_offset

    def set_aeternitas_offset(self, aeternitas_offset):
        self.aeternitas_offset = aeternitas_offset
        Qt.QMetaObject.invokeMethod(self._aeternitas_offset_line_edit, "setText", Qt.Q_ARG("QString", eng_notation.num_to_str(self.aeternitas_offset)))
        self.analog_sig_source_x_0_0.set_frequency(-1 * self.aeternitas_offset)


def main(top_block_cls=burst_trx_gmsk9600_ax25_n210_odu, options=None):
