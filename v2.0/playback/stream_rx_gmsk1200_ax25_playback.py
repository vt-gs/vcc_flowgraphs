...
# Title: VCC Stream TX/RX, 1200 Baud GMSK, AX.25, w/ PTT
# Author: Zach Leffke, KJ4QLP
# Description: VCC Burst TX/RX, 1200 Baud GMSK, AX.25
#
# Generated: Sat Dec 28 00:48:39 2019
...
from gmsk_ax25_rx_hier2 import gmsk_ax25_rx_hier2  # grc-generated hier_block
...
class stream_rx_gmsk1200_ax25_playback(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "VCC Stream TX/RX, 1200 Baud GMSK, AX.25, w/ PTT")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("VCC Stream TX/RX, 1200 Baud GMSK, AX.25, w/ PTT")
        ...
        self.settings = Qt.QSettings("GNU Radio", "stream_rx_gmsk1200_ax25_playback")
        ...
        self.baud = baud = 1200
        self.samps_per_symb = samps_per_symb = samp_rate/decim*interp /decim_2*interp_2/ baud
        self.rx_offset = rx_offset = samp_rate/2.0
        self.rx_freq = rx_freq = 401.08e6
        self.rate_factor = rate_factor = .5
        self.fsk_dev = fsk_dev = 2e3
        ...
        self.main_tab_grid_layout_1.addWidget(self._qtgui_time_sink_x_0_win, 1, 4, 2, 4)
        for r in range(1, 3):
            self.main_tab_grid_layout_1.setRowStretch(r, 1)
        for c in range(4, 8):
            self.main_tab_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.gmsk_ax25_rx_hier2_0 = gmsk_ax25_rx_hier2(
            lpf_cutoff=3e3,
            lpf_trans=1e3,
            quad_demod_gain=1,
        ...
        # Connections
        ##################################################
        self.msg_connect((self.gmsk_ax25_rx_hier2_0, 'kiss'), (self.blocks_socket_pdu_0_2, 'pdus'))
        self.msg_connect((self.gmsk_ax25_rx_hier2_0, 'ax25'), (self.vcc_qt_hex_text_tx_0, 'pdus'))
        ...
        self.connect((self.blocks_multiply_xx_0_0_0, 0), (self.rational_resampler_xxx_3, 0))
        ...
        self.connect((self.gmsk_ax25_rx_hier2_0, 0), (self.qtgui_freq_sink_x_1, 1))
        self.connect((self.gmsk_ax25_rx_hier2_0, 1), (self.qtgui_time_sink_x_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_3, 0), (self.gmsk_ax25_rx_hier2_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_samps_per_symb(self.samp_rate/self.decim*self.interp /self.decim_2*self.interp_2/ self.baud)
        ...
        self.gmsk_ax25_rx_hier2_0.set_samp_rate(self.samp_rate/self.decim*self.interp/self.decim_2*self.interp_2)
    ...
    def set_samps_per_symb(self, samps_per_symb):
        ...
        self.gmsk_ax25_rx_hier2_0.set_samps_per_symb(self.samps_per_symb)
...
def main(top_block_cls=stream_rx_gmsk1200_ax25_playback, options=None):
