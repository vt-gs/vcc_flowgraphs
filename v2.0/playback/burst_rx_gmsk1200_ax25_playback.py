...
# Title: VCC Burst TX/RX, 1200 Baud GMSK, AX.25, w/ PTT
# Author: Zach Leffke, KJ4QLP
# Description: VCC Burst TX/RX, 1200 Baud GMSK, AX.25
#
# Generated: Sat Dec 28 00:02:19 2019
...
from burst_rx_es_hier2 import burst_rx_es_hier2  # grc-generated hier_block
...
class burst_rx_gmsk1200_ax25_playback(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "VCC Burst TX/RX, 1200 Baud GMSK, AX.25, w/ PTT")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("VCC Burst TX/RX, 1200 Baud GMSK, AX.25, w/ PTT")
        ...
        self.settings = Qt.QSettings("GNU Radio", "burst_rx_gmsk1200_ax25_playback")
        ...
        self.baud = baud = 1200
        self.trigger_thresh = trigger_thresh = -10
        ...
        self.sigmf_source_0 = gr_sigmf.source('/home/zleffke/captures/vcc/VCC_VTGS_20191227_155437.sigmf-data', "cf32" + ("_le" if sys.byteorder == "little" else "_be"), False)
        ...
        self.main_tab_grid_layout_1.addWidget(self._qtgui_freq_sink_x_1_win, 0, 4, 1, 4)
        for r in range(0, 1):
            self.main_tab_grid_layout_1.setRowStretch(r, 1)
        for c in range(4, 8):
            self.main_tab_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.main_tab_grid_layout_1.addWidget(self._pyqt_ctime_plot_0_win, 1, 4, 1, 4)
        for r in range(1, 2):
            self.main_tab_grid_layout_1.setRowStretch(r, 1)
        for c in range(4, 8):
            self.main_tab_grid_layout_1.setColumnStretch(c, 1)
        ...
        self.gmsk_ax25_rx_hier_0 = gmsk_ax25_rx_hier(
            ...
            samp_rate=48000,
            samps_per_symb=samps_per_symb / 2,
        )
        ...
        self.burst_rx_es_hier2_0 = burst_rx_es_hier2(
            avg_len=avg_len,
            baud=baud,
        ...
        # Connections
        ##################################################
        self.msg_connect((self.burst_rx_es_hier2_0, 'burst_corr'), (self.pyqt_ctime_plot_0, 'cpdus'))
        self.msg_connect((self.burst_rx_es_hier2_0, 'meta'), (self.pyqt_meta_text_output_0, 'pdus'))
        ...
        self.connect((self.blocks_multiply_xx_0_0_0, 0), (self.burst_rx_es_hier2_0, 0))
        ...
        self.connect((self.burst_rx_es_hier2_0, 0), (self.rational_resampler_xxx_2, 0))
        self.connect((self.burst_rx_es_hier2_0, 1), (self.rational_resampler_xxx_3, 0))
        self.connect((self.fsk_burst_detector_0, 0), (self.burst_rx_es_hier2_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.burst_rx_es_hier2_0.set_samp_rate(self.samp_rate / self.decim *self.interp)
    ...
    def set_baud(self, baud):
        self.baud = baud
        self.set_samps_per_symb(self.samp_rate/self.decim*self.interp / self.baud)
        self.burst_rx_es_hier2_0.set_baud(self.baud)
    ...
    def set_trigger_thresh(self, trigger_thresh):
        ...
        self.burst_rx_es_hier2_0.set_trigger_thresh(self.trigger_thresh)
    ...
    def set_samps_per_symb(self, samps_per_symb):
        ...
        self.gmsk_ax25_rx_hier_0.set_samps_per_symb(self.samps_per_symb / 2)
        self.burst_rx_es_hier2_0.set_samps_per_symb(self.samps_per_symb)
    ...
    def set_event_length(self, event_length):
        self.event_length = event_length
        self.burst_rx_es_hier2_0.set_event_length(int(self.event_length))
    ...
    def set_avg_len(self, avg_len):
        ...
        self.fsk_burst_detector_0.set_avg_len(self.avg_len)
        self.burst_rx_es_hier2_0.set_avg_len(self.avg_len)


def main(top_block_cls=burst_rx_gmsk1200_ax25_playback, options=None):
