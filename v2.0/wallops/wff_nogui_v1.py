...
#
# Generated: Fri Sep 27 21:09:43 2019
...
class wff_nogui_v1(gr.top_block):
    ...
    def __init__(self, callsign='WJ2XMS', client_port='8000', gs_id='WFF', post_bytes=64, pre_bytes=64, sc_id='VCC-A', server_ip='0.0.0.0', ssid=0, verbose=0, wallops_dn_port='56101', wallops_up_port='56100'):
        ...
        self.connect((self.blocks_pdu_to_tagged_stream_0_0, 0), (self.sigmf_sink_1, 0))
        self.connect((self.blocks_pdu_to_tagged_stream_1, 0), (self.kiss_kiss_to_pdu_0, 0))
        self.connect((self.blocks_pdu_to_tagged_stream_1, 0), (self.sigmf_sink_0, 0))
...
def main(top_block_cls=wff_nogui_v1, options=None):
    if options is None:
